...
#read in data files
df.aqi<-read.csv("~/Documents/GitHub/PHP2550-PDA-project1/data/aqi_values.csv")
df.course.record<-read.csv("~/Documents/GitHub/PHP2550-PDA-project1/data/course_record.csv")
df.marathon.dates<-read.csv("~/Documents/GitHub/PHP2550-PDA-project1/data/marathon_dates.csv")
df.project1.main<-read.csv("~/Documents/GitHub/PHP2550-PDA-project1/data/project1.csv")
```
